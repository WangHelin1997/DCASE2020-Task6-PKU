...
from modules import Encoder, CNNEncoder, CNNEncoder2
from modules import Decoder, AttDecoder

__author__ = 'Konstantinos Drossos'
__docformat__ = 'reStructuredText'
__all__ = ['BaselineDCASE','CNNenc','CNNenc2']
...
class CNNenc(Module):
    ...
    def __init__(self,
        ...
        self.encoder: Module = CNNEncoder2()
    ...
    def forward(self,
        ...
        :rtype: torch.Tensor
        """
        h_encoder: Tensor = self.encoder(x).unsqueeze(1).expand(
            -1, self.max_out_t_steps, -1)
        return self.decoder(h_encoder)

class CNNenc2(Module):
    ...
    def __init__(self,
        ...
        self.decoder: Module = AttDecoder(
            input_dim=output_dim_encoder * 2,
            output_dim=output_dim_h_decoder,
    ...
    def forward(self,x: Tensor,y: Tensor,epoch,max_epoch) \
            -> Tensor:
        """Forward pass of the baseline method.
        ...
        return self.decoder(h_encoder,y,epoch,max_epoch)
